...
<body>
    ...
    $result = $pdo->query("SELECT * FROM employes WHERE prenom = 'Adam'");
    ...
    */
    ...
    $result = $pdo->query("SELECT * FROM employes WHERE prenom = 'David' ");
    ...
    $result = $pdo->query("SELECT * FROM employes WHERE prenom = 'Marco' ");
    $employe = $result->fetch();  // transforme l'objet $result en un ARRAY associatif et numérique
    debug($employe);
    echo $employe['prenom'] . '<br>';
    echo $employe[1] . '<br>';

    $result = $pdo->query("SELECT * FROM employes WHERE prenom = 'Jules' ");
